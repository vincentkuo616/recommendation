# -*- coding: utf-8 -*-
"""
Created on Fri Oct  8 11:08:03 2021

@author: syn009
"""

# 考慮電影類型 用人去 找相似度 MAPPING 
#%%
import numpy as np
import pandas as pd
...
#%%
#read movie data
movies = pd.read_csv(r"C:\vincent\Python\ml-25m\movies_2000.csv")
movies.columns
movies.drop('title',axis=1,inplace=True)
df = pd.read_csv(r"C:\vincent\Python\ml-25m\ratings_1M.csv")
...
print(get_the_most_similar_movies(1, user_movie_matrix,10))

#為movie1找出最相似的10個用戶
get_the_most_similar_users(1, user_movie_matrix,10)
print(get_the_most_similar_users(1, user_movie_matrix,10))